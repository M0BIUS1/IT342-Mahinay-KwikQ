package edu.cit.mahinay.kwikq.features.queue.entity;
...
public class BookQueue {
    ...
    public enum QueueStatus { WAITING, NOTIFIED, CANCELLED, FULFILLED }
    ...
    public BookQueue() {}
    public BookQueue(Book book, User user, Integer queuePosition) { this.book = book; this.user = user; this.queuePosition = queuePosition; this.status = QueueStatus.WAITING; }
