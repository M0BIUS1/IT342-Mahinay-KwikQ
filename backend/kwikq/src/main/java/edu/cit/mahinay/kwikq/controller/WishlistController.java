...
public class WishlistController {
    ...
    public ResponseEntity<?> getMyWishlist(
        ...
        try {
            ...
            Page<?> result = wishlistService.getUserWishlist(user, pageable)
    ...
    static class WishlistItemResponse {
        public Long id;
        public String title;
        ...
        public WishlistItemResponse(Long id, String title, String author, String category, Object addedAt) {
            this.id = id;
            this.title = title;
            this.author = author;
