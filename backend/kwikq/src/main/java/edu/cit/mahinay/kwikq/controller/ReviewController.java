...
public class ReviewController {
    ...
    public ResponseEntity<?> addReview(
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED)
                    .body(new ReviewResponse(review.getId(), user.getName(), rating, reviewText, review.getCreatedAt()));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getBookReviews(
        ...
        try {
            ...
            Page<ReviewResponse> result = reviewService.getBookReviews(book, pageable)
                    .map(r -> new ReviewResponse(r.getId(), r.getUser().getName(), r.getRating(), r.getReviewText(), r.getCreatedAt()));
