...
public class BookVerificationRequest {
    ...
    // Constructors
    public BookVerificationRequest() {}

    public BookVerificationRequest(String title, String author, String category, String uniqueCode) {
        this.title = title;
        this.author = author;
